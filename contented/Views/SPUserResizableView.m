...
double kSPUserResizableViewGlobalInset = 5.0;
double kSPUserResizableViewDefaultMinWidth = 48.0;
double kSPUserResizableViewDefaultMinHeight = 48.0;
double kSPUserResizableViewInteractiveBorderSize = 10.0;
